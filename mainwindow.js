...
const mainWindow = () => {
    ...
    async function dev_tools_func(x, y) {
        ...
        // console.log(backend_node);
        // console.log(backend_node_id);
        // console.log(resolved_node);
        console.log(html);
    }
    ...
    window.webContents.on('did-finish-load', () => {
        ...
        window.webContents.executeJavaScript("window.electronAPI.sendHTML(document.body.innerHTML);")
            .catch(function (e) {
